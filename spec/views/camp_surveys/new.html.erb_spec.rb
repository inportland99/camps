...
describe "camp_surveys/new" do
  before(:each) do
    assign(:camp_survey, stub_model(CampSurvey,
      :staisfaction => 1,
      :comment => "MyText",
      :improvements => "MyText",
  ...
  it "renders new camp_survey form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", camp_surveys_path, "post" do
