class CampsController < ApplicationController
  ...
  def update
    ...
    respond_to do |format|
      if @camp.update_attributes(camp_params)
        format.html { redirect_to action: "index", notice: 'Camp was successfully updated.' }
  ...
  private
    ...
    def camp_params
      params.require(:camp).permit(:age, :capacity, :description, :price, :title, :show_description, :girls_only, :video_url)
    end
end
