class CampsController < ApplicationController
  ...
  # GET /camps.json
  def index
    @camps = Camp.where(active: true).order(:id).all
  ...
  private
    ...
    def camp_params
      params.require(:camp).permit(:age, :capacity, :description, :price, :title, :show_description, :girls_only, :video_url, :online, :active, :parent_webpage)
    end
end
